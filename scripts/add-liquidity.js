...
const token0AmountDesired = parseEther('100')
const token1AmountDesired = parseEther('1000')
...
console.log('Adding liquidity:', token0AmountDesired, token1AmountDesired, token0AmountMin, token1AmountMin, to, deadline)
